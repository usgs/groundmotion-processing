...
# local libraries
from gmprocess.constants import LOG_FILE, LOG_CONFIG_FILE
...
def get_logger(eventid, log_option=None):
    """Return the logger instance.  Only use once!
...
def get_logging_config():
    ...
    conf_file = LOG_CONFIG_FILE
    spec_file = os.path.join(DATA_PATH, 'loggingspec.conf')
