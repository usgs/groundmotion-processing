...
def main():
    ...
    parser.add_argument("config_file", help="Path to desired output config file.")
    parser.add_argument(
        "-f", "--full-name", nargs="+", help="Supply the config with your name"
    )
    parser.add_argument(
        "-e", "--email", help="Supply the config with your email address"
    )
    parser.add_argument(
        "-l",
        "--list-sections",
    ...
    parser.add_argument(
        ...
        "--sections",
        nargs="+",
        help="Supply list of section names to include in output file.",
    )
    parser.add_argument(
        "-o",
        "--overwrite",
        action="store_true",
        help="Overwrite existing config file at the same location.",
    )
