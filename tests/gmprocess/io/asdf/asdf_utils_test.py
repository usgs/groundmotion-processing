...
def generate_workspace():
    ...
    st00.create_dataset("NET.ST00.00.HN1__TSTART_TEND__EV0_label", data=np.ones((300,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HN2__TSTART_TEND__EV0_label", data=np.ones((300,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HNZ__TSTART_TEND__EV0_label", data=np.ones((300,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HN1__TSTART_TEND__EV1_label", data=np.ones((400,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HN2__TSTART_TEND__EV1_label", data=np.ones((400,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HNZ__TSTART_TEND__EV1_label", data=np.ones((400,), dtype='float64'))
    st01 = waveforms.create_group("NET.ST01")
    st01.create_dataset("NET.ST01.10.HNE__TSTART_TEND__EV0_label", data=np.ones((300,), dtype='float64'))
    st01.create_dataset("NET.ST01.10.HNN__TSTART_TEND__EV0_label", data=np.ones((300,), dtype='float64'))
    st01.create_dataset("NET.ST01.10.HNZ__TSTART_TEND__EV0_label", data=np.ones((300,), dtype='float64'))
    ...
    processing_parameters.create_dataset("NET.ST00.00.HN1_EV0", data=np.ones((100,), dtype='int32'))
    processing_parameters.create_dataset("NET.ST00.00.HN1_EV1", data=np.ones((200,), dtype='int32'))
    processing_parameters.create_dataset("NET.ST01.10.HNE_EV0", data=np.ones((300,), dtype='int32'))
