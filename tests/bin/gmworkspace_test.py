...
def generate_workspace():
    ...
    quake_ml = h5.create_dataset("QuakeML", data=np.ones((14000,), dtype='uint8'))
    
    waveforms = h5.create_group("Waveforms")
    st00 = waveforms.create_group("NET.ST00")
    st00.create_dataset("NET.ST00.00.HN1__TSTART_TEND__EV0_label", data=np.ones((3000,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HN2__TSTART_TEND__EV0_label", data=np.ones((3000,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HNZ__TSTART_TEND__EV0_label", data=np.ones((3000,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HN1__TSTART_TEND__EV1_label", data=np.ones((4000,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HN2__TSTART_TEND__EV1_label", data=np.ones((4000,), dtype='float64'))
    st00.create_dataset("NET.ST00.00.HNZ__TSTART_TEND__EV1_label", data=np.ones((4000,), dtype='float64'))
    st01 = waveforms.create_group("NET.ST01")
    st01.create_dataset("NET.ST01.10.HNE__TSTART_TEND__EV0_label", data=np.ones((3000,), dtype='float64'))
    st01.create_dataset("NET.ST01.10.HNN__TSTART_TEND__EV0_label", data=np.ones((3000,), dtype='float64'))
    st01.create_dataset("NET.ST01.10.HNZ__TSTART_TEND__EV0_label", data=np.ones((3000,), dtype='float64'))
    ...
    waveform_metrics.create_dataset("NET.ST00_EV0", data=np.ones((1000,), dtype='uint8'))
    waveform_metrics.create_dataset("NET.ST00_EV1", data=np.ones((2000,), dtype='uint8'))
    waveform_metrics.create_dataset("NET.ST01_EV0", data=np.ones((3000,), dtype='uint8'))
    
    processing_parameters = aux_data.create_group("TraceProcessingParameters")
    processing_parameters.create_dataset("NET.ST00.00.HN1_EV0", data=np.ones((1000,), dtype='int32'))
    processing_parameters.create_dataset("NET.ST00.00.HN1_EV1", data=np.ones((2000,), dtype='int32'))
    processing_parameters.create_dataset("NET.ST01.10.HNE_EV0", data=np.ones((3000,), dtype='int32'))
...
def setup_module(module):
    ...
    setup_module.gmworkspace = pkg_resources.resource_filename(
        'gmprocess', os.path.join('..', 'bin', 'gmworkspace'))
    return
...
def test_describe():
    ...
    output = subprocess.check_output([gmworkspace, '--filename='+tfilename, '--describe'])
...
def test_storage():
    tfilename = setup_module.tfilename
    gmworkspace = setup_module.gmworkspace
    output = subprocess.check_output([gmworkspace, '--filename='+tfilename, '--compute-storage'])
