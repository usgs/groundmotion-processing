...
\begin{tikzpicture}[diagram]
  ...
  \node (prov0) [below=of provenance.center, dataset, xml, subset-right] {\variable{NET.STA.LOC.CHAN\suscore{}EVENTID\suscore{}LABEL}};
  \node (prov1) [below=of prov0.west, dataset, xml] {\variable{NET.STA.LOC.CHAN\suscore{}EVENTID\suscore{}LABEL}};
  \node (prov2) [below=of prov1.west, dataset, xml] {\variable{NET.STA.LOC.CHAN\suscore{}EVENTID\suscore{}LABEL}};
