...
\begin{tikzpicture}[diagram]
  ...
  \node (wm-st0) [below=of wf-metrics.center, group, subset-right] {\variable{NET\suscore{}STA}};
  \node (wm-st0-wf0) [below=of wm-st0.center, dataset, xml, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID\suscore{}LABEL}};
  \node (wm-st0-wf1) [below=of wm-st0-wf0.west, dataset, xml] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID\suscore{}LABEL}};
  \node (wm-st1) [below=of wm-st0.west, group, yshift=-5.0em] {\variable{NET\suscore{}STA}};
  \node (wm-st1-wf0) [below=of wm-st1.center, dataset, xml, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID\suscore{}LABEL}};
  ...
  \node (sm-st0) [below=of st-metrics.center, group, subset-right] {\variable{NET\suscore{}STA}};
  \node (sm-st0-eq0) [below=of sm-st0.center, dataset, xml, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID}};
  \node (sm-st0-eq1) [below=of sm-st0-eq0.west, dataset, xml] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID}};
  \node (sm-st1) [below=of sm-st0.west, group, yshift=-5em] {\variable{NET\suscore{}STA}};
  \node (sm-st1-eq0) [below=of sm-st1.center, dataset, xml, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID}};
  \node (sm-st1-eq1) [below=of sm-st1-eq0.west, dataset, xml] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID}};
  ...
  \node (tp-st0) [below=of tr-processing.center, group, subset-right] {\variable{NET\suscore{}STA}};
  \node (tp-st0-eq0) [below=of tp-st0.center, dataset, json, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \node (tp-st0-eq1) [below=of tp-st0-eq0.west, dataset, json] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \node (tp-st1) [below=of tp-st0.west, group, yshift=-5em] {\variable{NET\suscore{}STA}};
  \node (tp-st1-eq0) [below=of tp-st1.center, dataset, json, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \node (tp-st1-eq1) [below=of tp-st1-eq0.west, dataset, json] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  ...
  \node (sp-st0) [below=of st-processing.center, group, subset-right] {\variable{NET\suscore{}STA}};
  \node (sp-st0-eq0) [below=of sp-st0.center, dataset, json, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID\suscore{}LABEL}};
  \node (sp-st0-eq1) [below=of sp-st0-eq0.west, dataset, json] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID\suscore{}LABEL}};
  \node (sp-st1) [below=of sp-st0.west, group, yshift=-5em] {\variable{NET\suscore{}STA}};
  \node (sp-st1-eq0) [below=of sp-st1.center, dataset, json, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID\suscore{}LABEL}};
  \node (sp-st1-eq1) [below=of sp-st1-eq0.west, dataset, json] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}INST\suscore{}EVENTID\suscore{}LABEL}};
  ...
  % Auxiliary arrays (noise, spectra)
  \node (aux-arrays) [below=of st-processing.west, group, yshift=-15.5em] {AuxArrays};
  \node (aa-st0) [below=of aux-arrays.center, group, subset-right] {\variable{NET\suscore{}STA}};
  \node (aa-st0-eq0) [below=of aa-st0.center, dataset, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \node (aa-st0-eq1) [below=of aa-st0-eq0.west, dataset] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \node (aa-st1) [below=of aa-st0.west, group, yshift=-5em] {\variable{NET\suscore{}STA}};
  \node (aa-st1-eq0) [below=of aa-st1.center, dataset, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \node (aa-st1-eq1) [below=of aa-st1-eq0.west, dataset] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \draw[arrowto] (auxdata.south) |- (aux-arrays.west);
  \draw[arrowto] (aux-arrays.south) |- (aa-st0.west);
  \draw[arrowto] (aa-st0.south) |- (aa-st0-eq0.west);
  \draw[arrowto] (aa-st0.south) |- (aa-st0-eq1.west);
  \draw[arrowto] (aux-arrays.south) |- (aa-st1.west);
  \draw[arrowto] (aa-st1.south) |- (aa-st1-eq0.west);
  \draw[arrowto] (aa-st1.south) |- (aa-st1-eq1.west);

  % Waveforms on ground surface
  \node (wf-groundsurf) [below=of aux-arrays.west, group, yshift=-15.5em] {SurfaceWaveforms};
  ...
  % Provenance
  \node (provenance) [below=of auxdata.west, group, yshift=-130.5em] {Provenance};
  \node (prov0) [below=of provenance.center, dataset, xml, subset-right] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \node (prov1) [below=of prov0.west, dataset, xml] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
  \node (prov2) [below=of prov1.west, dataset, xml] {\variable{NET\suscore{}STA\suscore{}LOC\suscore{}CHA\suscore{}EVENTID\suscore{}LABEL}};
